...
----
dependencies {
    griffon '{project-group}:griffon-fatcowicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fatcowicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fatcowicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fatcowicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fatcowicons-javafx-groovy:{project-version}'
}
----
